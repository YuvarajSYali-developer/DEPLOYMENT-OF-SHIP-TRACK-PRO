...
DATABASE_URL = os.environ.get("DATABASE_URL", "sqlite:///./indian_shipment.db")
...
# For development, allow all origins if in dev mode
...
def create_db_and_tables():
    ...
    with Session(engine) as session:
        ...
        if not existing_shipments:
            ...
            print("[OK] Sample shipments created")
...
if __name__ == "__main__":
    ...
    # Get port from environment variable (for Railway, Heroku, etc.) or default to 8001
